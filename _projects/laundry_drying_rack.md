...
img: assets/img/laundry_drying_rack.png
importance: 5
...
- Parameter optimization via analysis of means (ANOM) to find the optimal design combination
- Physical experiments to validate the simulation results

**Tools**: Solidworks, ANSYS Workbench
